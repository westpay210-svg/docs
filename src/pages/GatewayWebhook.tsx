...
export const GatewayWebhook: React.FC = () => {
  const webhookRequestParams = [
    { name: 'transactionReference', type: 'string', required: true, description: 'Unique reference for the transaction generated by KiwiFinance.' },
    ...
    { name: 'transactionFee', type: 'decimal', required: true, description: 'Fee charged by KiwiFinance for processing the transaction.' },
