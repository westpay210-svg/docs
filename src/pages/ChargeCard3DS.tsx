...
export const ChargeCard3DS: React.FC = () => {
    const requestParameters = [
        ...
        {name: 'cvv', type: 'string', required: true, description: 'The card\'s CVV security code.'},
        {
            ...
            type: 'int',
            required: true,
            description: 'The transaction amount. (in cents format e.g "1000" is 10 USD)'
        },
        ...
        {name: 'sourceUrl', type: 'string', required: false, description: 'The originating URL.'},
        {
            ...
            type: 'string',
            required: true,
            description: 'Custom webhook URL for notifications. The webhookUrl must start with http or https to ensure it is a valid URL.'
        },
        {
            name: 'browserDetails',
            type: 'object',
            required: true,
            description: 'Detailed information about the payer\'s browser. When provided, increase the transaction success rate'
        },
        {
            name: 'customer',
            type: 'object',
            required: true,
            description: 'Detailed information on the customer making the payment. When provided, it increases the transaction success rate'
        },
        {
            name: 'Terminal ID (TID)',
            type: 'string',
            required: true,
            description: 'Uniquely identifies a specific payment terminal, virtual endpoint, or logical channel under a merchant account (MID)'
        }
    ];
    ...
    const responseFields = [
        ...
        {name: 'authorizationType', type: 'string', description: 'Indicates the type of authentication required.'},
        {
            name: 'acsUrl',
            type: 'string',
            description: 'The URL to which the customer must be redirected to complete 3DS authentication.'
        },
        {
            name: 'reference',
            type: 'string',
            description: 'A unique reference for the transaction, used to track the payment process.'
        },
        ...
        {
            name: 'paymentRequestor',
            type: 'string',
            description: 'The entity or system initiating the payment request, such as a the merchant.'
        }
    ];
    ...
    return (
        <div className="max-w-4xl">
                ...
                <StepList steps={[
                    {
                        ...
                        description: 'Start the payment process and redirect the customer to the ACS (Access Control Server) for 3DS authentication.'
                    },
                    {
                        title: 'Verify the Payment',
                        description: 'Confirm the payment status after the customer completes the 3DS authentication.'
                    },
                ]}/>
            </div>
            ...
            <div className="mb-8">
                ...
                <div
                    className="flex items-center gap-2 px-4 py-3 bg-slate-50 border border-slate-200 rounded font-mono text-[13px] mb-4">
                    <span
                        className="px-2 py-0.5 text-[11px] font-bold bg-teal-50 text-teal-700 border border-teal-200 rounded">POST</span>
            ...
            <Callout type="warning" title="3DS Redirect Required">
                Merchant must redirect the user to <code>acsUrl</code> for 3DS authentication. Upon completion, the user
                is redirected to the callback URL with the following parameters:
            ...
            <div className="mb-8">
                ...
                <Callout type="danger" title="Invalid Webhook URL">
                    If the webhookUrl does not start with <code>http</code> or <code>https</code>, the system will
            ...
            <div className="flex items-center justify-between pt-6 border-t border-slate-200 mt-10">
                ...
                <Link to="/server-to-server/charge-card-2ds"
