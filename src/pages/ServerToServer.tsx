    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="mb-12">
        <div className="flex items-center gap-3 mb-4">
          <div className="p-2 rounded-md bg-accent-500/10 border border-accent-500/20">
            <Server className="h-6 w-6 text-accent-400" />
          </div>
          <h1 className="text-3xl font-bold text-slate-900">Server-to-Server</h1>
        </div>
      ...
      <div className="mb-12">
        <div className="glass rounded-md p-6">
          <h2 className="text-lg font-semibold text-slate-900 mb-6">API Capabilities</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {features.map((feature, index) => (
              <div key={index} className="flex items-start gap-3 p-3 rounded-md hover:bg-slate-50 transition-colors">
                <div className="p-2 rounded bg-kiwi-500/10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
        ...
        <div className="group relative overflow-hidden rounded-md bg-gradient-to-br from-red-500/10 via-red-500/5 to-transparent border border-red-500/20 p-6 hover:border-red-500/40 transition-all duration-300">
          ...
          <div className="relative">
            <div className="inline-flex items-center justify-center w-12 h-12 rounded-md bg-red-500/20 mb-4">
              <Shield className="h-6 w-6 text-red-400" />
            </div>

            <h3 className="text-xl font-semibold text-slate-900 mb-4">API Authentication</h3>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm text-slate-600">All requests must be initiated from the server to protect the merchant's private key.</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="flex items-center justify-center w-5 h-5 rounded-full bg-red-500/20 flex-shrink-0 mt-0.5">
                  <Check className="h-3 w-3 text-red-400" />
                </div>
                <span className="text-sm text-slate-600">Requests must originate from whitelisted IP addresses associated with the private key.</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="group relative overflow-hidden rounded-md bg-gradient-to-br from-accent-500/10 via-accent-500/5 to-transparent border border-accent-500/20 p-6 hover:border-accent-500/40 transition-all duration-300">
          ...
          <div className="relative">
            <div className="inline-flex items-center justify-center w-12 h-12 rounded-md bg-accent-500/20 mb-4">
              <Lock className="h-6 w-6 text-accent-400" />
            </div>

            <h3 className="text-xl font-semibold text-slate-900 mb-4">Security Headers</h3>
      ...
      <div className="mb-12">
        <div className="glass rounded-md overflow-hidden">
          <div className="px-6 py-4 border-b border-slate-200">
            <h3 className="text-lg font-semibold text-slate-900">Required Headers</h3>
          </div>
              ...
              <tbody className="divide-y divide-white/5">
                {securityHeaders.map((header, index) => (
                  <tr key={index} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-mono text-slate-500">{header.value}</td>
                    ...
                    <td className="px-6 py-4 text-sm text-slate-500">{header.description}</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      {/* Important Notes */}
      <div className="mb-12">
        <div className="group relative overflow-hidden rounded-md bg-gradient-to-br from-yellow-500/10 via-yellow-500/5 to-transparent border border-yellow-500/20 p-6">
          ...
          <div className="relative flex items-start gap-4">
            <div className="p-2 rounded-md bg-yellow-500/20 flex-shrink-0">
              <AlertTriangle className="h-5 w-5 text-yellow-400" />
            </div>
            <div>
              <h3 className="text-lg font-semibold text-slate-900 mb-3">Important Notes</h3>
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <span className="text-yellow-400 mt-1">•</span>
                  <span className="text-sm text-slate-600">Create and set-up your business profile on the merchant dashboard</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-yellow-400 mt-1">•</span>
                  <span className="text-sm text-slate-600">Ensure the private key is securely stored and never exposed on the client side.</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div className="relative overflow-hidden rounded-md">
        ...
        <div className="relative p-8 text-center">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-white text-dark font-semibold rounded-md hover:bg-white/90 transition-colors"
          >
            Environments
