...
export const authenticationEndpoint: ApiEndpoint = {
  ...
  description: 'Generate an access token using your API key and client ID. This token is required for all subsequent API calls.',
  parameters: [
    {
      name: 'x-api-key',
      type: 'string',
...
export const virtualAccountsEndpoints: ApiEndpoint[] = [
  {
    ...
    description: 'Create a reserved virtual account for an individual customer. This account is permanently linked and can be used for multiple transactions.',
    parameters: [
      {
        name: 'Authorization',
        type: 'string',
...
console.log(data);`
  ...
  },
  {
    ...
    description: 'Create a reserved virtual account for a corporate customer. This account is permanently linked to the business entity.',
    parameters: [
      {
        name: 'Authorization',
        type: 'string',
  ...
  },
  {
    ...
    description: 'Create a temporary virtual account with a fixed amount. Perfect for one-time payments.',
    parameters: [
      {
        name: 'Authorization',
        type: 'string',
...
console.log(data);`
  ...
  },
  {
    ...
    description: 'Transfer funds from a virtual or reserved account to a beneficiary account. Used by those who have created virtual or reserved accounts to send money.',
    parameters: [
      {
        name: 'x-api-key',
        type: 'string',
    ...
    requestBody: {
      type: 'application/json',
      description: 'Fund transfer details including beneficiary and debitor information',
      schema: {},
      example: {
...
print(data)`
  ...
  },
  {
    ...
    description: 'Check the transaction status for reserve account transfer using its original reference',
    parameters: [
      {
        name: 'Authorization',
        type: 'string',
    ...
    responses: [
      {
        status: 200,
        description: 'Reserve account transaction status retrieved successfully',
        example: {
  ...
  },
  {
    ...
    description: 'Create a temporary virtual account that accepts flexible amount and multiple payments.',
    parameters: [
      {
        name: 'Authorization',
        type: 'string',
  ...
  },
  {
    ...
    description: 'Check the transaction status for payment into static virtual account using its request id',
    parameters: [
      {
        name: 'Authorization',
        type: 'string',
  ...
  },
  {
    ...
    description: 'Check the transaction status for payments into dynamic virtual account using its request id',
    parameters: [
      {
        name: 'Authorization',
        type: 'string',
    ...
    responses: [
      {
        status: 200,
        description: 'Dynamic account transaction status retrieved successfully',
        example: {
...
export const payoutsEndpoints: ApiEndpoint[] = [
  {
    ...
    description: 'Retrieve a list of all supported banks for transfers. This includes bank codes, names, and logos.',
    parameters: [
      {
        name: 'Authorization',
        type: 'string',
          ...
          content: [
            {
              ...
              logoUrl: 'https://akumfb.blob.core.windows.net/assets/ASSET/7e21fd55-f3f0-4c63-a4c9-61137cdd778f.svg'
            },
            {
              id: '0a76ed31-2a96-4cf2-9186-231f404ffdcb',
              code: '000013',
              name: 'GTBANK PLC',
              logoUrl: 'https://akumfb.blob.core.windows.net/assets/ASSET/0a76ed31-2a96-4cf2-9186-231f404ffdcb.svg'
            }
          ],
          totalElements: 570,
          totalPages: 1,
...
console.log(data.content); // Array of banks`
  ...
  },
  {
    ...
    description: 'Verify account details before initiating a transfer. Returns the account holder name for the given account number and bank.',
    parameters: [
      {
        name: 'Authorization',
        type: 'string',
...
console.log(data.name); // Account holder name`
  ...
  },
  {
    ...
    description: 'Send money to a bank account. The transfer can be processed immediately or queued based on your account settings.',
    parameters: [
      {
        name: 'Authorization',
        type: 'string',
...
console.log(data.reference); // Transfer reference`
  ...
  },
  {
    ...
    description: 'Check the current status of a transfer using its request ID. Track whether the transfer is PENDING, COMPLETE, or FAILED.',
    parameters: [
      {
        name: 'Authorization',
        type: 'string',
  ...
  },
  {
    ...
    responses: [
      ...
      },
      {
        ...
        example: {
          error: 'Account not found',
          message: 'The specified account number does not exist or is not accessible'
        }
      }
    ],
    codeExamples: [
