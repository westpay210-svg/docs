      ...
      <div className="max-w-md w-full space-y-8">
        <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl shadow-2xl p-8">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-white">Kiwi Finance API</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  className="appearance-none block w-full pl-10 pr-3 py-2 bg-dark border border-white/20 rounded-lg placeholder-white/40 text-white focus:outline-none focus:ring-2 focus:ring-lime focus:border-transparent"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex justify-center py-2 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-dark bg-lime hover:bg-lime/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-lime disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
